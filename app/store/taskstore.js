...
// ─── In-Memory Store ──────────────────────────────────────────────────────────
// Simulates a database using a plain array. Resets on pod restart (by design).
let tasks = [
  {
    id: uuidv4(),
    title: 'Set up Jenkins pipeline',
    description: 'Configure CI/CD pipeline with build, test, and deploy stages',
    status: 'in-progress',
    priority: 'high',
  ...
  },
  {
    ...
    description: 'Containerize the Node.js application with a multi-stage build',
    status: 'done',
    priority: 'high',
    createdAt: new Date().toISOString(),
    updatedAt: new Date().toISOString(),
